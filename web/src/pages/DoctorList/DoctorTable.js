...
const EnhancedTableToolbar = (props) => {
  ...
  const { numSelected, deleteDoctor } = props;
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete" onClick={deleteDoctor}>
...
function DoctorTable({ rows, selected, setSelected, deleteDoctor }) {
